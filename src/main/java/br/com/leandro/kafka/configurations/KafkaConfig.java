package br.com.leandro.kafka.configurations;
...
public class KafkaConfig {
	...
	private final static String IPKAFKA = "127.0.0.1:9092";
	
	@Bean
	public ProducerFactory<String, SimpleModel> producerFactory(){
		Map<String, Object> config = new HashMap<>();
		config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, IPKAFKA);
	...
	public ConsumerFactory<String, SimpleModel> consumerFactory(){
		Map<String, Object> config = new HashMap<>();
		config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, IPKAFKA);
